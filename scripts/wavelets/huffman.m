function [code,codelength,meanlength]=huffman5(p);
%HUFFMAN5
%HUFFMAN CODER FOR V5
% Format [code,codelength,compression]=HUFFMAN(P)
%
...
% MEANLENGTH gives the codeword average length
%
