...
% Prend en compte la permutation    
...
function [G_lagr, H_lagr_1, H_lagr_2, EQM_1, EQM_2, P_1, P_2, Q] = TER_Foreman_opti_lagr_new_perm(Lambda,pt,N)


% load N1 Plus besoin de ça
% load N2

N_1=N{1}; %Calculés dans le mM!
N_2=N{2};
...
H_1{1}=Lambda*G_1'/(G_1*Lambda*G_1' + N_1P); %D?j? H' en fait!!!!
